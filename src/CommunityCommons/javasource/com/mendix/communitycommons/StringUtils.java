package com.mendix.communitycommons;
...
import com.mendix.communitycommons.proxies.XSSPolicy;
	...
	public static String XSSSanitize(String html, String policyString)
		...
		if (policyString == null) {
			throw new Exception("Unable to perform XSS sanitization: policyString is null");
                ...
                String filename = String.format("/antisamy-%s-1.4.4.xml", policyString);
