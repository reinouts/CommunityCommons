...
import com.mendix.communitycommons.StringUtils;
...
public class XSSSanitize extends CustomJavaAction<java.lang.String>
{
	...
	private com.mendix.communitycommons.proxies.XSSPolicy policy;

	public XSSSanitize(IContext context, java.lang.String html, java.lang.String policy)
	{
		super(context);
		this.html = html;
		this.policy = policy == null ? null : com.mendix.communitycommons.proxies.XSSPolicy.valueOf(policy);
	}
